                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <asp:TextBox ID="txtFecha" runat="server"></asp:TextBox>
                                    ...
                                    <asp:GridView class= "align-content-md-center" ID="grdpronosticosdeldia" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
